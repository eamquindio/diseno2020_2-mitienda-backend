...
INSERT INTO public.orders(id, "date", state, total_value, id_store, id_user)VALUES(1, '01/01/2020', 'created', 10000, 1, 1);
...
INSERT INTO public.order_products(id, quantity, state, id_order, id_product)VALUES(15, 1, 'created', 1, 2);