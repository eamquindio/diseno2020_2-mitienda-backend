...
INSERT INTO public.products (id, image, "name") VALUES(3, 'img.jpg', 'piña');

INSERT INTO public.products_store (id, price, stock, id_category, id_product, id_store) VALUES(1, 100, 20, 1, 1, 1);
INSERT INTO public.products_store (id, price, stock, id_category, id_product, id_store) VALUES(2, 100, 20, 1, 2, 1);
INSERT INTO public.products_store (id, price, stock, id_category, id_product, id_store) VALUES(3, 100, 20, 1, 3, 1);

INSERT INTO public.orders (id, "date", state, total_value, id_store, id_user) VALUES(1,'2016-06-22 19:10:25-07', 'in course', 1200, 1, 1);

INSERT INTO public.order_products (id, quantity, state, id_order, id_product) VALUES(1, 4, 'pending', 1, 1);
INSERT INTO public.order_products (id, quantity, state, id_order, id_product) VALUES(2, 4, 'pending', 1, 2);
