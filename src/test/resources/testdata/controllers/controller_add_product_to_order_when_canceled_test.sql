...
INSERT INTO public.orders(id, "date", state, total_value, id_store, id_user)VALUES(1, '01/01/2020', 'canceled', 10000, 1, 1);
...
INSERT INTO public.products_store(id, price, stock, id_category, id_product, id_store)VALUES(3, 300, 30, 3, 3, 1);

INSERT INTO public.order_products(id, quantity, state, id_order, id_product)VALUES(10, 1, 'canceled', 1, 1);
INSERT INTO public.order_products(id, quantity, state, id_order, id_product)VALUES(15, 1, 'canceled', 1, 2);